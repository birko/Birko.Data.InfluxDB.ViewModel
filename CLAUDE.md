...
### Repositories
- `InfluxDBRepository<TViewModel, TModel>` - Sync bulk ViewModel repository
  - `SetSettings()`, `IsHealthy()`, `Drop()` methods
- `AsyncInfluxDBRepository<TViewModel, TModel>` - Async bulk ViewModel repository
  - `SetSettings()`, `IsHealthy()`, `DropAsync()` methods
